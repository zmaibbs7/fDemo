...
const ::uint32_t
    TableStruct_header_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        PROTOBUF_FIELD_OFFSET(::packet::MessagePacketHeader, _impl_.data_length_),
        PROTOBUF_FIELD_OFFSET(::packet::MessagePacketHeader, _impl_.packet_id_),
        PROTOBUF_FIELD_OFFSET(::packet::MessagePacketHeader, _impl_.packet_checksum_),
        ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::packet::MessagePacketHeader)},
        {13, -1, -1, sizeof(::packet::FilePacketHeader)},
};
...
const char descriptor_table_protodef_header_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\014header.proto\022\006packet\"\226\001\n\023MessagePacket"
    "Header\022\024\n\014magic_number\030\001 \001(\005\022(\n\013packet_t"
    "ype\030\002 \001(\0162\023.packet.MessageType\022\023\n\013data_l"
    "ength\030\003 \001(\005\022\021\n\tpacket_id\030\004 \001(\005\022\027\n\017packet"
    "_checksum\030\005 \001(\005\"7\n\020FilePacketHeader\022\021\n\tf"
    "ile_name\030\001 \001(\t\022\020\n\010file_md5\030\002 \001(\t*1\n\013Mess"
...
MessagePacketHeader::MessagePacketHeader(
    ::google::protobuf::Arena* arena, const MessagePacketHeader& from)
...
inline void MessagePacketHeader::SharedCtor(::_pb::Arena* arena) {
  ...
  ::memset(reinterpret_cast<char *>(&_impl_) +
           ...
           0,
           offsetof(Impl_, packet_checksum_) -
               offsetof(Impl_, magic_number_) +
               sizeof(Impl_::packet_checksum_));
}
MessagePacketHeader::~MessagePacketHeader() {
...
const ::_pbi::TcParseTable<3, 5, 0, 0, 2> MessagePacketHeader::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    // int32 data_length = 3;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(MessagePacketHeader, _impl_.data_length_), 63>(),
     {24, 63, 0, PROTOBUF_FIELD_OFFSET(MessagePacketHeader, _impl_.data_length_)}},
    // int32 packet_id = 4;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(MessagePacketHeader, _impl_.packet_id_), 63>(),
     {32, 63, 0, PROTOBUF_FIELD_OFFSET(MessagePacketHeader, _impl_.packet_id_)}},
    // int32 packet_checksum = 5;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(MessagePacketHeader, _impl_.packet_checksum_), 63>(),
     {40, 63, 0, PROTOBUF_FIELD_OFFSET(MessagePacketHeader, _impl_.packet_checksum_)}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
    65535, 65535
    ...
    // int32 magic_number = 1;
    {PROTOBUF_FIELD_OFFSET(MessagePacketHeader, _impl_.magic_number_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kInt32)},
    // .packet.MessageType packet_type = 2;
    {PROTOBUF_FIELD_OFFSET(MessagePacketHeader, _impl_.packet_type_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kOpenEnum)},
    // int32 data_length = 3;
    {PROTOBUF_FIELD_OFFSET(MessagePacketHeader, _impl_.data_length_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kInt32)},
    // int32 packet_id = 4;
    {PROTOBUF_FIELD_OFFSET(MessagePacketHeader, _impl_.packet_id_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kInt32)},
    // int32 packet_checksum = 5;
    {PROTOBUF_FIELD_OFFSET(MessagePacketHeader, _impl_.packet_checksum_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kInt32)},
  }},
  // no aux_entries
  {{
...
// @@protoc_insertion_point(message_clear_start:packet.MessagePacketHeader)
  ...
  ::memset(&_impl_.magic_number_, 0, static_cast<::size_t>(
      reinterpret_cast<char*>(&_impl_.packet_checksum_) -
      reinterpret_cast<char*>(&_impl_.magic_number_)) + sizeof(_impl_.packet_checksum_));
...
::uint8_t* MessagePacketHeader::_InternalSerialize(
  ...
  if (this->_internal_data_length() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::
        WriteInt32ToArrayWithField<3>(
            stream, this->_internal_data_length(), target);
  }
  ...
  // int32 packet_checksum = 5;
  if (this->_internal_packet_checksum() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::
        WriteInt32ToArrayWithField<5>(
            stream, this->_internal_packet_checksum(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:packet.MessagePacketHeader)
  ...
  if (this->_internal_packet_checksum() != 0) {
    total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(
        this->_internal_packet_checksum());
  }
...
void MessagePacketHeader::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  if (from._internal_packet_checksum() != 0) {
    _this->_impl_.packet_checksum_ = from._impl_.packet_checksum_;
  }
...
void MessagePacketHeader::InternalSwap(MessagePacketHeader* PROTOBUF_RESTRICT other) {
  ...
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MessagePacketHeader, _impl_.packet_checksum_)
      + sizeof(MessagePacketHeader::_impl_.packet_checksum_)
      - PROTOBUF_FIELD_OFFSET(MessagePacketHeader, _impl_.magic_number_)>(
